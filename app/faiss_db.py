...
# #     if not os.path.exists(path) or not os.path.exists(index_file):
...
# #         # 🔥 DEBUG: Pehle chunk ka preview
# #         if chunks_with_meta and len(chunks_with_meta) > 0:
# #             print(f"Sample chunk: {chunks_with_meta[0]['text'][:100]}...")
